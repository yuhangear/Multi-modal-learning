...
class Trainer:
    ...
    def resume(
        ...
        my_epoch=True
        if my_epoch:
            checkpoint="exp/asr_conformer_lr2e-3_warmup15k_amp_nondeterministic_start_33/cosin_10avg.pth"
            #checkpoint="exp/asr_conformer_lr2e-3_warmup15k_amp_nondeterministic_start_3/59epoch.pth"
            # checkpoint="/home3/yuhang001/espnet/egs2/librispeech_100/letter/exp/asr_conformer_lr2e-3_warmup15k_amp_nondeterministic/checkpoint.pth"
            # checkpoint="exp/asr_conformer_lr2e-3_warmup15k_amp_nondeterministic_start_333_lm2/valid.acc._text_all_80_re.pth"
            # checkpoint="exp/asr_conformer_lr2e-3_warmup15k_amp_nondeterministic_start_333_lm2/34epoch.pth"
            states = torch.load(
                checkpoint,
