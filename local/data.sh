...
LIBRISPEECH="/home3/yuhang001/corpus/LibriSpeech/"
...
#     for part in dev-clean test-clean  test-other train-clean-100; do
#         # use underscore-separated names in data directories.
#         local/data_prep.sh ${LIBRISPEECH}/${part} data/${part//-/_}
#     done
# fi
